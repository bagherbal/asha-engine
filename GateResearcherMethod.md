...
- If a command times out, narrow scope rather than retrying blindly: identify package boundaries, warm the build cache, reduce verbose output, and defer historical suites.
