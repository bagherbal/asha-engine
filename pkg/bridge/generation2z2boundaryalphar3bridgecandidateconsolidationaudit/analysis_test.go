...
func TestGate935BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate935Theorem(t *testing.T) {
	res := Generation2Z2BoundaryAlphaR3BridgeCandidateConsolidationAuditTheorem().Verify()
