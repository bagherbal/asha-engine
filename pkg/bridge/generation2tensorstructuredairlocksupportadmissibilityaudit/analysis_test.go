...
func TestGate932BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate932Theorem(t *testing.T) {
	res := Generation2TensorStructuredAirlockSupportAdmissibilityAuditTheorem().Verify()
