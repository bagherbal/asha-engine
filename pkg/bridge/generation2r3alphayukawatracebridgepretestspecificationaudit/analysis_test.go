...
func TestGate936BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate936Theorem(t *testing.T) {
	res := Generation2R3AlphaYukawaTraceBridgePreTestSpecificationAuditTheorem().Verify()
