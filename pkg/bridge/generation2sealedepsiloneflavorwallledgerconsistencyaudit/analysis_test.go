...
func TestGate966BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate966Theorem(t *testing.T) {
	res := Generation2SealedEpsilonEFlavorWallLedgerConsistencyAuditTheorem().Verify()
