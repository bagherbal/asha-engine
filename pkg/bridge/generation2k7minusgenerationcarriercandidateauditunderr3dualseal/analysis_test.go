...
func TestGate951BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate951Theorem(t *testing.T) {
	res := Generation2K7MinusGenerationCarrierCandidateAuditUnderR3DualSealTheorem().Verify()
