...
func TestGate953BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate953Theorem(t *testing.T) {
	res := Generation2R4GenerationCarrierComparisonFlavorFormulaFirewallAuditTheorem().Verify()
