...
func TestGate970BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate970Theorem(t *testing.T) {
	res := Generation2TripleSealedFlavorLedgerDiagnosticSynthesisAuditTheorem().Verify()
