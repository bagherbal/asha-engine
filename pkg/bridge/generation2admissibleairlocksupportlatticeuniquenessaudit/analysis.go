// Package generation2admissibleairlocksupportlatticeuniquenessaudit implements
...
package generation2admissibleairlocksupportlatticeuniquenessaudit
...
const (
	AuditID         = "GATE933-GENERATION2ADMISSIBLEAIRLOCKSUPPORTLATTICEUNIQUENESSAUDIT"
	InheritedStatus = "R3_ALPHA_TENSOR_STRUCTURED_ADMISSIBILITY_SUPPORTED_NATIVE_SOURCE_MISSING"
	Classification  = "R3_ADMISSIBLE_AIRLOCK_SUPPORT_LATTICE_UNIQUE_BRIDGE_NOT_NATIVE"
	ShortStatus     = "R3_ALPHA_ADMISSIBLE_SUPPORT_LATTICE_UNIQUE_UNDER_RULES_NOT_NATIVE"
	FinalTruth      = "ADMISSIBLE_AIRLOCK_SUPPORT_LATTICE_UNIQUE_UNDER_TENSOR_STRUCTURED_COMPLETION_RULES"
	NextGate        = "NEXT_PRESSURE_GATE934_CLOSUREFACTORED_BOUNDARYACTIVATIONMEASURE_CONSOLIDATION_AUDIT"
...
func BuildDefault() (Analysis, error) {
	...
	return Analysis{
		...
		Truth:          FinalTruth,
		Components: []ComponentAudit{
			{Name: "unique lattice under tensor rules", Marker: "CONDITIONAL_SUPPORT_ADMISSIBLE_SUPPORT_LATTICE_IS_UNIQUE_UNDER_TENSOR_STRUCTURED_RULES", Passed: true, Detail: "A_airlock={F_0,F_1,F_2} is the unique minimal admissible chain under the bridge rules"},
			{Name: "orphan opposite socket rejected", Marker: "CONDITIONAL_SUPPORT_NO_ORPHAN_OPPOSITE_SOCKET_FRAGMENT_ALLOWED", Passed: true, Detail: "opposite-socket singleton or color fragments are not admissible intermediate supports"},
			{Name: "arbitrary rank subspace rejected", Marker: "CONDITIONAL_SUPPORT_NO_ARBITRARY_RANK_COMPATIBLE_SUBSPACE_ALLOWED", Passed: true, Detail: "rank alone cannot create an admissible airlock support"},
			{Name: "minimal three levels", Marker: "CONDITIONAL_SUPPORT_MINIMAL_AIRLOCK_LATTICE_HAS_EXACTLY_THREE_LEVELS", Passed: true, Detail: "one base, one same-socket completion, one saturated support"},
			{Name: "Z2 representative independence", Marker: "CONDITIONAL_SUPPORT_Z2_ADMISSIBLE_LATTICE_IS_REPRESENTATIVE_INDEPENDENT", Passed: true, Detail: "lambda and barlambda representatives give the same class lattice"},
		},
		Numeric:  n,
		Statuses: Statuses(),
		Supports: Supports(),
		Failures: Failures(),
		Final:    "Gate 933 upgrades the support lattice from sourced/plausible to unique under tensor-structured completion rules, while preserving that the uniqueness is bridge-level, not native.",
	}, nil
}

func Statuses() []string {
	return []string{
		"PASS_GATE933_ADMISSIBLE_SUPPORT_LATTICE_IS_UNIQUE_UNDER_TENSOR_STRUCTURED_RULES",
		"PASS_GATE933_NO_ORPHAN_OPPOSITE_SOCKET_FRAGMENT_ALLOWED",
		"PASS_GATE933_NO_ARBITRARY_RANK_COMPATIBLE_SUBSPACE_ALLOWED",
		"PASS_GATE933_MINIMAL_AIRLOCK_LATTICE_HAS_EXACTLY_THREE_LEVELS",
		"PASS_GATE933_Z2_ADMISSIBLE_LATTICE_IS_REPRESENTATIVE_INDEPENDENT",
		"FIREWALL_PRESERVED_GATE933_NOT_NATIVE",
	}
}

func Supports() []string {
	return []string{
		"CONDITIONAL_SUPPORT_ADMISSIBLE_SUPPORT_LATTICE_IS_UNIQUE_UNDER_TENSOR_STRUCTURED_RULES",
		"CONDITIONAL_SUPPORT_NO_ORPHAN_OPPOSITE_SOCKET_FRAGMENT_ALLOWED",
		"CONDITIONAL_SUPPORT_NO_ARBITRARY_RANK_COMPATIBLE_SUBSPACE_ALLOWED",
		"CONDITIONAL_SUPPORT_MINIMAL_AIRLOCK_LATTICE_HAS_EXACTLY_THREE_LEVELS",
		"CONDITIONAL_SUPPORT_Z2_ADMISSIBLE_LATTICE_IS_REPRESENTATIVE_INDEPENDENT",
	}
}
