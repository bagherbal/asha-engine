...
func TestGate933BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate933Theorem(t *testing.T) {
	res := Generation2AdmissibleAirlockSupportLatticeUniquenessAuditTheorem().Verify()
