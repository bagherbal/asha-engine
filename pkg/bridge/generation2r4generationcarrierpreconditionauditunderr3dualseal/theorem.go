...
const (
	theoremID   = "GEN2-GATE950-GENERATION2R4GENERATIONCARRIERPRECONDITIONAUDITUNDERR3DUALSEAL"
	theoremName = "Gate 950: R4 GenerationCarrier Precondition Audit Under R3 DualSeal"
)

func Generation2R4GenerationCarrierPreconditionAuditUnderR3DualSealTheorem() theorem.Theorem {
	return theorem.Theorem{ID: theoremID, Name: theoremName, Layer: theorem.LayerBridge, Status: theorem.BridgeRequired, Verify: func() theorem.Result {
		a, err := BuildDefault()
		if err != nil {
			return theorem.Result{ID: theoremID, Name: theoremName, Layer: theorem.LayerBridge, Status: theorem.FailedRoute, Checks: []theorem.Check{{Name: "build default Gate 950 audit", Passed: false, Detail: err.Error()}}, Notes: []string{Verdict, Classification, ShortStatus}}
		}
