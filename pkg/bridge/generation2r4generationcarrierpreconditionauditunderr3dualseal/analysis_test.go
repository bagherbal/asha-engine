...
func TestGate950BuildDefault(t *testing.T) {
	a, err := BuildDefault()
	if err != nil {
		t.Fatal(err)
	}
...
func TestGate950Theorem(t *testing.T) {
	res := Generation2R4GenerationCarrierPreconditionAuditUnderR3DualSealTheorem().Verify()
