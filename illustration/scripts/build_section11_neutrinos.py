...
from asha_figures.readme_neutrinos import neutrino_contract, export_contract, validate_contract
from asha_figures.section11_svg import render_neutrinos
from asha_figures.style import STYLE


def main() -> None:
    parser = argparse.ArgumentParser(description="Build ASHA README neutrino seesaw/PMNS firewall visual.")
    parser.add_argument("--out", default="outputs/section11", help="Output directory, relative to toolkit root unless absolute.")
