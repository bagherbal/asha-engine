...
from asha_figures.readme_theorem_stack import theorem_stack_contract, export_contract, validate_contract
from asha_figures.section14_svg import render_theorem_stack
from asha_figures.style import STYLE


def main() -> None:
    parser = argparse.ArgumentParser(description="Build ASHA README theorem-level stack visual.")
    parser.add_argument("--out", default="outputs/section14", help="Output directory, relative to toolkit root unless absolute.")
    ...
    render_theorem_stack(c, svg_path)
