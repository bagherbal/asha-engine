...
from asha_figures.readme_gravity import gravity_contract, export_contract, validate_contract
from asha_figures.section12_svg import render_gravity
from asha_figures.style import STYLE


def main() -> None:
    parser = argparse.ArgumentParser(description="Build ASHA README gravity metric projection/firewall visual.")
    parser.add_argument("--out", default="outputs/section12", help="Output directory, relative to toolkit root unless absolute.")
