...
from asha_figures.readme_quarks import quarks_contract, export_contract, validate_contract
from asha_figures.section9_svg import render_quarks
from asha_figures.style import STYLE


def main() -> None:
    parser = argparse.ArgumentParser(description="Build ASHA README quark lane/shape-law visual.")
    parser.add_argument("--out", default="outputs/section9", help="Output directory, relative to toolkit root unless absolute.")
