...
from asha_figures.readme_ckm import ckm_contract, export_contract, validate_contract
from asha_figures.section10_svg import render_ckm
from asha_figures.style import STYLE


def main() -> None:
    parser = argparse.ArgumentParser(description="Build ASHA README CKM orientation/transport visual.")
    parser.add_argument("--out", default="outputs/section10", help="Output directory, relative to toolkit root unless absolute.")
